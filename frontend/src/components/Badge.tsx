const colors: Record<string, string> = {
  ...
  waiting_for_agent: "bg-amber-500/20 text-amber-200",
  ...
  review_due: "bg-amber-500/20 text-amber-200",
  review_overdue: "bg-orange-500/20 text-orange-200",
  expired: "bg-rose-500/20 text-rose-200",
  superseded: "bg-slate-500/20 text-slate-300",
  retired: "bg-slate-500/20 text-slate-300",
  related: "bg-cyan-500/20 text-cyan-200",
  evidence: "bg-sky-500/20 text-sky-200",
  supports: "bg-indigo-500/20 text-indigo-200",
  "related control": "bg-cyan-500/20 text-cyan-200",
  "evidence reference": "bg-sky-500/20 text-sky-200",
  "supporting evidence": "bg-indigo-500/20 text-indigo-200",
