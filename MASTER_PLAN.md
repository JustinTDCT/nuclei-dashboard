...
- **V1B — Operational Release Readiness.** ACCEPT / CLOSED on `bb63c6b` (PR #1). No product features, no V1A PARTIAL/MISSING UX fixes, no schema, no `0018`, no Agent pin change, no reopening S1–S3. Evidence: `docs/V1B_CLOSURE.md`. Runbook: `docs/V1B_OPERATIONS.md`.
