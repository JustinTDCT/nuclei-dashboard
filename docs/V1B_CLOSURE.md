...
**V1B acceptance checkpoint:** the GitHub merge commit of [PR #2](https://github.com/JustinTDCT/nuclei-dashboard/pull/2) (this change). That merge SHA is the immutable acceptance reference.  
