...
def infer_class(hostname: str = "", ports: list | None = None, title: str = "", tech: str = "") -> str:
    ...
    rules = [
        ...
        ("Print Server (non server)", ("printer", "print-server", "jetdirect", "cups", "laserjet", "officejet", "printers", "brother", "epson", "kyocera", "canon", "lexmark")),
        ...
        ("Switch", ("switch", "catalyst", "procurve", "netgear gs", "-sw-", "sw0", "cisco ios", "cisco nx-os", "junos")),
