...
def test_generated_agent_compose_is_immutably_pinned(monkeypatch):
    ...
    assert "956d510385b26d9715daa43ea1e2d0d733e0a56b" in compose
    ...
    assert "956d510385b26d9715daa43ea1e2d0d733e0a56b" in root
    assert "956d510385b26d9715daa43ea1e2d0d733e0a56b" in agent_file
